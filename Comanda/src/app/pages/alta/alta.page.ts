...
export class AltaPage implements OnInit {
  ...
  ngOnInit() {
    this.myForm = new FormGroup({
      ...
      cuil: new FormControl('', [Validators.required, this.onlyNumbersValidator]),
    });
    this.typeEmployed = this.activeRoute.snapshot.paramMap.get('typeEmployed');
    this.titleTypeEmployed = this.typeEmployed === 'S' ? 'Alta dueño/supervisor' : 'Alta Empleado';
